         ...
         <nav className="navbar navbar-default navbar-fixed-side-left" role="navigation">
           <div className="navbar-header">
            ...
            <div className="navbar-logobox">
              <a href="/">
                <img className="navbar-logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1200px-React-icon.svg.png" alt="Logo"/>
              </a>
            </div>
           </div>
           <div className="navbar-collapse collapse">
            <ul className="nav navbar-nav">
              ...
              <li className="navbar-listitem"><Link to="/contacto">Contacto</Link></li>
            </ul>
           </div>
         </nav>
       </div>
